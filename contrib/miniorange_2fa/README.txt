...
------------
	...
	* If you want to login from the mobile browser then any authentication method can be converted into Security Questions(KBA) by just one click.
	...
	TOTP (Time-based One-time Passcode) apps supported by miniOrange two factor authentication:
	...
	* Out of Band Email (User will receive Accept and Deny transaction link on Email)
	* Google Authenticator
	...
	* User Behavior
	...
	For support please email us at drupalsupport@xecurify.com or call us at +1 978 658 9387
...
------------
    ...
    OR
    You can follow this ( https://plugins.miniorange.com/drupal-2fa-setup-guides ) guide.

CONFIGURATION
-------------
	* Configure Two-Factor Authentication in Configuration » People » miniOrange Two-Factor Authentication:

	1. Register with miniOrange. If you already have miniOrange account, enter your username and password to retrieve your account.
	2. Once the account is retrieved, go to Setup Two-Factor tab to configure the authentication method you would like to use.
	3. If you need help, go to Support tab and submit your query. You can also email us at drupalsupport@xecurify.com or info@xecurify.com

	You can follow this ( https://plugins.miniorange.com/drupal-2fa-setup-guides ) guide to setup 2FA