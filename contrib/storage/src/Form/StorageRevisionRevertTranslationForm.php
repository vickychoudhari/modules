...
/**
 * Provides a form for reverting a Storage revision for a single trans.
 *
 * @ingroup storage
 */
class StorageRevisionRevertTranslationForm extends StorageRevisionRevertForm {
  ...
  public function getFormId() {
    return 'storage_revision_revert_translation_confirm';
  }
   ...
   * {@inheritdoc}
   */
  public function buildForm(array $form, FormStateInterface $form_state, $storage_revision = NULL, $langcode = NULL) {
    $this->langcode = $langcode;
    $form = parent::buildForm($form, $form_state, $storage_revision);
