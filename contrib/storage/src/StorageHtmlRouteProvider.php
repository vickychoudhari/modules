...
/**
 * Provides routes for Storage entities.
 *
 * @see \Drupal\Core\Entity\Routing\AdminHtmlRouteProvider
 * @see \Drupal\Core\Entity\Routing\DefaultHtmlRouteProvider
 */
class StorageHtmlRouteProvider extends AdminHtmlRouteProvider {
    ...
    if ($entity_type->hasLinkTemplate('version-history')) {
      ...
      $route
        ->setDefaults([
          ...
          '_controller' => '\Drupal\storage\Controller\StorageController::revisionOverview',
        ])
        ->setRequirement('_permission', 'view all storage revisions')
  ...
  protected function getRevisionRevertRoute(EntityTypeInterface $entity_type) {
    if ($entity_type->hasLinkTemplate('revision_revert')) {
      ...
      $route
        ->setDefaults([
          '_form' => '\Drupal\storage\Form\StorageRevisionRevertForm',
  ...
  protected function getRevisionDeleteRoute(EntityTypeInterface $entity_type) {
    if ($entity_type->hasLinkTemplate('revision_delete')) {
      ...
      $route
        ->setDefaults([
          '_form' => '\Drupal\storage\Form\StorageRevisionDeleteForm',
          '_title' => 'Delete earlier revision',
        ])
        ->setRequirement('_permission', 'delete all storage revisions')
        ->setOption('_admin_route', TRUE);
